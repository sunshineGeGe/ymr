...
<script type="text/javascript" src="<?php echo JS_PATH;?>blowup.min.js"></script>
<script type="text/javascript" src="<?php echo JS_PATH;?>prism.js"></script>


<div class="main photo-channel" style="text-aligen:center;width:960px;margin:0 auto;">
